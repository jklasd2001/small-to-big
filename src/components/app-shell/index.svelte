...
<header class="fixed left-0 top-0 h-16 w-screen border-b border-b-base-300">
  ...
  >
    <a href="/">
      <img src="/logo.png" alt="logo" class="h-8 rounded-full" />
    </a>

    <div class="flex items-center gap-4">
      <a href="/birthday-letter" class="btn btn-ghost">편지</a>

      <a href="/invitation-card" class="btn btn-ghost">초대장</a>
...
<div class="mt-16 min-h-[calc(100vh-64px)] p-4">
  {@render children()}
</div>
